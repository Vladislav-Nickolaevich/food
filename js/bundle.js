...
function forms(formSelector, modalTimerId) {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', function (e) {
      ...
      form.append(statusMessage); // XMLHttpRequest
  ...
  function showThanksModal(message) {
    ...
    setTimeout(function () {
      ...
      (0,_modal__WEBPACK_IMPORTED_MODULE_9__.closeMod)('.modal');
    }, 4000);
  }
}
...
function timer(id, deadLine) {
  function getTimeRemaining(endtime) {
    ...
    if (t <= 0) {
      ...
      days = Math.round(t / (1000 * 60 * 60 * 24)), hours = Math.round(t / (1000 * 60 * 60) % 24), minutes = Math.round(t / 1000 / 60 % 60), seconds = Math.round(t / 1000 % 60);
    }
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_8__["default"])('.timer', '2022-05-25');
});
})();
